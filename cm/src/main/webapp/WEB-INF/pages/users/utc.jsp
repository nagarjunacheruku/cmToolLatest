...
<!-- BEGIN FORM-->
                ...
                <ul id="fieldlist">
                            <li>
                        <div class="k-edit-label"><label for="utcCode" class="required control-label w140px">UTC Code: </label> </div>
                       <input type="text" id="utcCode" name=" UTC Code" class="k-textbox w30p k-state-disabled" placeholder="UTC Code" required validationMessage="Enter {0}"  />
                        
                    </li>
                     <li>
                        <div class="k-edit-label"><label for="utcName" class="required control-label w140px">UTC Name: </label> </div>
                       <input type="text" id="utcName" name=" UTC Name" class="k-textbox  w30p k-state-disabled" placeholder="UTC Name" required validationMessage="Enter {0}"  />
                        
                    </li>
                    <li>
                     <div class="k-edit-label"><label for="utcName" class="required control-label w140px"></label> </div>
                     <button class="k-button k-button-icontext k-primary" id="btnSave" >
															<span class="k-icon k-update"></span>Save</button>
															
															 <div class="k-edit-label"><label for="utcName" class="required control-label w140px"></label> </div>
                     <button class="k-button k-button-icontext k-primary btnUTC" id="btnUpdate" >
															<span class="k-icon k-update"></span>Update</button>
															 <button class="k-button k-button-icontext k-primary btnUTC" id="btnDelete" >
  ...
  <input type="radio" name="sitprj" value="PRJ"> PRJ
	...
	<a id="popupBoxClose">Close</a>	
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa"></i> Search And Update UTC</h3>
                            </div>
								...
								<form action="#">
									<div class="input-group m1t">
										...
										<span class="input-group-btn">
											<button type="button" class="btn blue" id="btnSearch">
